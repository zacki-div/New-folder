    ...
    <aside className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <input name="name" value={form.name} onChange={handleChange} placeholder="Full name" className="h-11 px-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-orange-200 outline-none" required />
          <input name="phone" value={form.phone} onChange={handleChange} placeholder="Phone" className="h-11 px-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-orange-200 outline-none" />
        </div>

        <textarea name="address" value={form.address} onChange={handleChange} placeholder="Delivery address" className="w-full min-h-20 px-3 py-2 rounded-lg border border-gray-200 focus:ring-2 focus:ring-orange-200 outline-none" required />
